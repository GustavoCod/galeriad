...
<asp:Content ID="cStoreImages" ContentPlaceHolderID="cphStoreImages" runat="Server">
    <li>
        <img src="fotos/collet/collet1.jpg" alt="collet. Foto del local 1" />
    </li>
    <li>
        <img src="fotos/collet/collet2.jpg" alt="collet. Foto del local 2" />
    </li>
    <li>
        <img src="fotos/collet/collet3.jpg" alt="collet. Foto del local 3" />
    </li>
    <li>
        <img src="fotos/collet/collet4.jpg" alt="collet. Foto del local 4" />
    </li>
    <li>
        <img src="fotos/collet/collet5.jpg" alt="collet. Foto del local 5" />
    </li>
    <li>
