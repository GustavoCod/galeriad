...
<asp:Content ID="cStoreImages" ContentPlaceHolderID="cphStoreImages" runat="Server">
    <li>
        <img src="fotos/elgatosinbotas/elgatosinbotas1.jpg" alt="elgatosinbotas. Foto del local 1" />
    </li>
    <li>
        <img src="fotos/elgatosinbotas/elgatosinbotas2.jpg" alt="elgatosinbotas. Foto del local 2" />
    </li>
    <li>
        <img src="fotos/elgatosinbotas/elgatosinbotas3.jpg" alt="elgatosinbotas. Foto del local 3" />
    </li>
    <li>
        <img src="fotos/elgatosinbotas/elgatosinbotas4.jpg" alt="elgatosinbotas. Foto del local 4" />
    </li>
    <li>
        <img src="fotos/elgatosinbotas/elgatosinbotas5.jpg" alt="elgatosinbotas. Foto del local 5" />
    </li>
    <li>
        <img src="fotos/elgatosinbotas/elgatosinbotas6.jpg" alt="elgatosinbotas. Foto del local 6" />
    </li>
    <li>
        <img src="fotos/elgatosinbotas/elgatosinbotas7.jpg" alt="elgatosinbotas. Foto del local 7" />
    </li>         
