<%@ Page Title="Faro Norte" Language="C#" MasterPageFile="~/locales/Local.master" AutoEventWireup="true" CodeFile="faronorte.aspx.cs" Inherits="locales_faronorte" %>

<asp:Content ID="cMetaDescription" ContentPlaceHolderID="cphMetaDescription" runat="Server">
    <meta name="description" content="faronorte" />
</asp:Content>
...
<asp:Content ID="cStoreImages" ContentPlaceHolderID="cphStoreImages" runat="Server">
    <li>
        <img src="fotos/faronorte/faronorte1.jpg" alt="faronorte. Foto del local 1" />
    </li>
    <li>
        <img src="fotos/faronorte/faronorte2.jpg" alt="faronorte. Foto del local 2" />
    </li>
    <li>
        <img src="fotos/faronorte/faronorte3.jpg" alt="faronorte. Foto del local 3" />
    </li>
    <li>
        <img src="fotos/faronorte/faronorte4.jpg" alt="faronorte. Foto del local 4" />
    </li>
...
<asp:Content ID="cStoreContactInfo" ContentPlaceHolderID="cphStoreContactInfo" runat="Server">
    <p class="workdate">
        <span class="label">Teléfono:</span>  4504-5949
    </p>
    <!--<p class="workdate">
    ...
    <p class="skills">
        <span class="label">Local:</span> 9-60
    </p>
</asp:Content>
