<%@ Page Language="C#" MasterPageFile="~/locales/Local.master" AutoEventWireup="true" CodeFile="iavagni.aspx.cs" Inherits="locales_iavagni" %>
...
<asp:Content ID="cStoreContactInfo" ContentPlaceHolderID="cphStoreContactInfo" runat="Server">
    <p class="workdate">
        <span class="label">Teléfono:</span> 4503-0555
    </p>
    <p class="workdate">
        <span class="label">Mail:</span> iavagni@hotmail.com
    </p>
    <p class="workdate">
...
<asp:Content ID="cStoreDescription" ContentPlaceHolderID="cphStoreDescription" runat="Server">
    <p>
        Iavagni. Lencería. Ropa de fiesta.
    </p>
</asp:Content>
