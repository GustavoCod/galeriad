...
<asp:Content ID="cStoreImages" ContentPlaceHolderID="cphStoreImages" runat="Server">
    <li>
        <img src="fotos/chiquilin/chiquilin1.jpg" alt="chiquilin. Foto del local 1" />
    </li>
    <li>
        <img src="fotos/chiquilin/chiquilin2.jpg" alt="chiquilin. Foto del local 2" />
    </li>
    <li>
        <img src="fotos/chiquilin/chiquilin3.jpg" alt="chiquilin. Foto del local 3" />
    </li>
    <li>
        <img src="fotos/chiquilin/chiquilin4.jpg" alt="chiquilin. Foto del local 4" />
    </li>
