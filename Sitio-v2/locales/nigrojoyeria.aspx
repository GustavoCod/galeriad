...
<asp:Content ID="cStoreImages" ContentPlaceHolderID="cphStoreImages" runat="Server">
    <li>
        <img src="fotos/nigrojoyeria/nigrojoyeria1.jpg" alt="nigro. Foto del local 1" />
    </li>
    <li>
        <img src="fotos/nigrojoyeria/nigrojoyeria2.jpg" alt="nigro. Foto del local 5" />
    </li>
    <li>
        <img src="fotos/nigrojoyeria/nigrojoyeria3.jpg" alt="nigro. Foto del local 6" />
    </li>    
