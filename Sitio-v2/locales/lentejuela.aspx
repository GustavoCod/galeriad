<%@ Page Language="C#" MasterPageFile="~/locales/Local.master" AutoEventWireup="true" CodeFile="lentejuela.aspx.cs" Inherits="locales_lentejuela" %>
...
<asp:Content ID="cStoreImages" ContentPlaceHolderID="cphStoreImages" runat="Server">
    <li>
        <img src="fotos/lentejuela/lentejuela1.jpg" alt="lentejuela. Foto del local 1" />
    </li>
    <li>
        <img src="fotos/lentejuela/lentejuela2.jpg" alt="lentejuela. Foto del local 2" />
    </li>
    <li>
...
<asp:Content ID="cStoreContactInfo" ContentPlaceHolderID="cphStoreContactInfo" runat="Server">
    <p class="workdate">
        <span class="label">Teléfono:</span> 4504-7209
    </p>
    <!--<p class="workdate">
    ...
    <p class="skills">
        <span class="label">Local:</span> 21
    </p>
</asp:Content>
<asp:Content ID="cStoreDescription" ContentPlaceHolderID="cphStoreDescription" runat="Server">
    <p>
        Indumentaria de alta calidad y elegancia para la mujer.
    </p>
    <p>
        Comercio histórico en la zona, que prestigia la Gran Galería Devoto, desde hace más de 20 años de ininterrumpida trayectoria, con su tradicional buen gusto, y atención esmerada.
    </p>
</asp:Content>
<asp:Content ID="cRelatedStores" ContentPlaceHolderID="cphRelatedStores" runat="Server">
    <ul>
        ...
        <li class="work-item group"><a class="work-thumb" href="#">
            <img src="../images/various/more-project-widget/0041-86x86.jpg" alt="0041" title="0041" /></a> <a class="meta work-title" href="#">lentejuela</a>
            <p class="meta categories">
