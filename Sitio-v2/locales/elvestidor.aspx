<%@ Page Language="C#" MasterPageFile="~/locales/Local.master" AutoEventWireup="true" CodeFile="elvestidor.aspx.cs" Inherits="locales_elvestidor" %>

<asp:Content ID="cMetaDescription" ContentPlaceHolderID="cphMetaDescription" runat="Server">
    <meta name="description" content="elvestidor" />
</asp:Content>
...
<asp:Content ID="cStoreImages" ContentPlaceHolderID="cphStoreImages" runat="Server">
    <li>
        <img src="fotos/elvestidor/elvestidor1.jpg" alt="elvestidor. Foto del local 1" />
    </li>
    <li>
        <img src="fotos/elvestidor/elvestidor2.jpg" alt="elvestidor. Foto del local 2" />
    </li>
    <li>
        <img src="fotos/elvestidor/elvestidor3.jpg" alt="elvestidor. Foto del local 3" />
    </li>
    <li>
        <img src="fotos/elvestidor/elvestidor4.jpg" alt="elvestidor. Foto del local 4" />
    </li>
    <li>
        <img src="fotos/elvestidor/elvestidor5.jpg" alt="elvestidor. Foto del local 5" />
    </li>
...
<asp:Content ID="cStoreContactInfo" ContentPlaceHolderID="cphStoreContactInfo" runat="Server">
    <p class="workdate">
        <span class="label">Teléfono:</span>  4503-9713
    </p>
    <!--<p class="workdate">
    ...
    <p class="skills">
        <span class="label">Local:</span> 23
    </p>
</asp:Content>
<asp:Content ID="cStoreDescription" ContentPlaceHolderID="cphStoreDescription" runat="Server">
    <p>
        El Vestidor. Indumentaria femenina.
    </p>
</asp:Content>
